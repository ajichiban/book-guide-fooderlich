...
class Home extends StatefulWidget {
  static MaterialPage page({required int currentTab}) {
    return MaterialPage(
  ...
  Widget build(BuildContext context) {
    return Consumer<AppStateManager>(
      ...
      return Scaffold(
        ...
        //NOTE //* IndexedStack mantiene el stado (y scroll) de todas las paginas
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (index) {
          //REVIEW  //*Provider.of<AppStateManager>(context, listen: false).goToTab(index);
